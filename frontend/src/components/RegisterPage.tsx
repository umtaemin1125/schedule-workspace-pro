  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sand to-white flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <h1 className="text-2xl font-bold text-ink">업무 일정 관리 회원가입</h1>
        <form onSubmit={submit} className="mt-4 space-y-3">
          ...
          <Link className="block text-center text-sm text-slate-600 hover:underline" to="/login">이미 계정이 있으면 로그인</Link>
        </form>
      </Card>
    </div>
  )
